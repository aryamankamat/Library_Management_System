...
<style>
    ...
    .innerright {
        background-color: rgb(200, 224, 112);
    }
    ...
    <div class="container">
        <div class="innerdiv">
            ...
            <div class="leftinnerdiv">
                ...
                <Button class="greenbtn" onclick="openpart('addperson')"> ADD Users</Button>
                <Button class="greenbtn" onclick="openpart('studentrecord')"> Users REPORT</Button>
            ...
            <div class="rightinnerdiv">
                <div id="addbook" class="innerright portion" style="<?php if (!empty($_REQUEST['viewid'])) {
                    ...
                    <form action="addbookserver_page.php" method="post" enctype="multipart/form-data">
                        ...
                        <div>Branch:<input type="radio" name="branch" value="other" />other<input type="radio" name="branch" value="BSIT" />BCA<div style="margin-left:80px"><input type="radio" name="branch" value="BSCS" />BSC<input type="radio" name="branch" value="BSSE" />BBA</div>
                        </div>
            ...
            <div class="rightinnerdiv">
                <div id="issuebookreport" class="innerright portion" style="display:none">
                    <Button class="greenbtn">Issued Book Record</Button>
