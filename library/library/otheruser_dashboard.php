...
<style>
    ...
    .innerright {
        background-color: rgb(222, 193, 49);
    }
...
<body>
    ...
    <div class="container">
        <div class="innerdiv">
            ...
            padding: 8px;'>Name</th><th>Book Name</th><th>Issue Date</th><th>Return Date</th><th>Fine</th></tr>";
            ...
            <div class="rightinnerdiv">
                <div id="return" class="innerright portion" style="<?php if (!empty($_REQUEST['returnid'])) {
                    ...
                    <Button class="greenbtn">ISSUED Books</Button>
